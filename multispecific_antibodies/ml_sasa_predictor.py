# Import necessary libraries (tools we need to do our job)
import pandas as pd             
from Bio.SeqUtils.ProtParam import ProteinAnalysis          # Biopython tool to analyze protein sequences
from pathlib import Path       
import warnings                                             # Tool to control warning messages
import re                                                   # Tool for finding patterns in text (Regular Expressions)
import importlib.util           
from Bio import BiopythonDeprecationWarning                 # A specific warning type we want to hide
